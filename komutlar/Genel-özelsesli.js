...
let kategori = ayarlar.ozelseslikanalkategori
let kanalid = ayarlar.ozelseslikanal

exports.run = async (client, message, args) => {
    const error = (str) => message.channel.send(new Discord.MessageEmbed().setColor('RED').setTitle('Hata').setDescription(str));

    const privateChannelID = kanalid 
    const categoryID = kategori; 
